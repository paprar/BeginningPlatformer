...
public class PlayerTest6_5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 벽 감지
        isWall = Physics2D.Raycast(transform.position, Vector2.right * (sprite.flipX ? 1 : -1), 1f, wallLayer);
        ...
        if (Input.GetKeyDown(KeyCode.Space))
        {
            ...
            { 
                    ...
                    rigid.velocity = new Vector2(-1* wallJumpForce, jumpForce);
